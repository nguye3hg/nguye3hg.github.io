    ...
    <div id="Work">
      <div id="part1">
        <div id="workContainer">
          <a href="https://cp.certmetrics.com/amazon/en/public/verify/credential/adbba4828a2d4d1e8f8a12daff364dd0">
            <div id="workCard1">
          ...
          <a href="https://d7u7nkp3zjlik.cloudfront.net/About">
            <div id="workCard2">
              <h2>IRAS LAB WEBSITE</h2>
              <h3>IRAS LAB</h3>
              <div id="pjImgfixer2">
          ...
          <a href="https://github.com/nguye3hg/finace-tracker">
            <div id="workCard3">
          ...
          <a href="https://makeuc.netlify.app/">
            <div id="workCard4">
              <h2>The Crox</h2>
