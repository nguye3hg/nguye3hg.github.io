...
function changeCat(){
    if(appear){
        ...
        document.getElementById('Cat1').style.transition='visibility 0s 2s, opacity 2s linear';
        appear=true;
    }
}
        ...
        <div id='expContainer'>
            <div id='Experience'>
                <div id='ExpContainer'>
                    ...
                    <div id='slider'> 
                        <h2>MY EXPERIENCE</h2><br></br>
                        <h3>
                            <div id='logoContainer1'>
                                <img src={UClogo} alt=''></img>
                            </div>
                            <div id='TA'>
                                Teaching assistant at UC
                            </div>
                        </h3><br></br>
                        <h3>
                            ...
                            <div id='Coop1'>
                                 UC center for eutrepeneurship Coop
                            </div>                        
                        </h3><br></br>
